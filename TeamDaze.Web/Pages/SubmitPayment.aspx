...
<asp:content id="Content2" contentplaceholderid="MainContent" runat="server">
 ...
 <div class="form-group" style="border-radius:inherit;">
     <br />
...
<%--   <asp:radioButtonList ID="radio1" runat="server" TextAlign="Right"  RepeatLayout="Flow" RepeatDirection="Horizontal">
     ...
     <asp:Button ID="Button1"  class="btn btn-warning" runat="server"  Height="45px" OnClick="Button1_Click" Text="Make Payment" Width="157px" />
